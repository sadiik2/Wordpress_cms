...
<!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|body-text"}}},"spacing":{"margin":{"top":"var:preset|spacing|20","bottom":"0"}}},"textColor":"body-text","fontSize":"small"} -->
<p class="has-text-align-center has-body-text-color has-text-color has-link-color has-small-font-size" style="margin-top:var(--wp--preset--spacing--20);margin-bottom:0"><?php esc_html_e('Up to 60% off on Handloom clothing &amp; furnishings','clothing-store-blocks'); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group has-border-color" style="border-color:#dad9d1;border-width:1px;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><!-- wp:post-terms {"term":"category","textAlign":"left","className":"cat-name","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"500","fontSize":"12px"}},"textColor":"secondary"} /-->

<!-- wp:post-title {"level":6,"style":{"typography":{"fontSize":"17px"},"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} /-->

<!-- wp:post-excerpt {"excerptLength":16,"style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}},"elements":{"link":{"color":{"text":"var:preset|color|body-text"}}},"typography":{"fontSize":"14px"}},"textColor":"body-text"} /-->

<!-- wp:group {"className":"post-meta","style":{"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"0"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
