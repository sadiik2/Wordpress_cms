...
<div class="wp-block-group bannerimage" style="margin-top:0px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cover {"overlayColor":"primary","isUserOverlayColor":true,"minHeight":750,"minHeightUnit":"px","isDark":false,"align":"wide","className":"banner-image-cover","layout":{"type":"constrained","contentSize":"70%"}} -->
<div class="wp-block-cover alignwide is-light banner-image-cover" style="min-height:750px"><span aria-hidden="true" class="wp-block-cover__background has-primary-background-color has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:columns {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-center banner-content wow pulse" style="flex-basis:50%"><!-- wp:heading {"level":6,"style":{"elements":{"link":{"color":{"text":"var:preset|color|top-bg-color"}}}},"textColor":"top-bg-color","fontSize":"small"} -->
<h6 class="wp-block-heading has-top-bg-color-color has-text-color has-link-color has-small-font-size"><?php esc_html_e('NEW ARRIVAL COLLECTION','clothing-store-blocks'); ?></h6>
<!-- /wp:heading -->

<!-- wp:heading {"level":1,"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"typography":{"fontSize":"55px","lineHeight":"1.2"},"spacing":{"margin":{"top":"var:preset|spacing|20","bottom":"0"}}},"textColor":"white"} -->
<h1 class="wp-block-heading has-white-color has-text-color has-link-color" style="margin-top:var(--wp--preset--spacing--20);margin-bottom:0;font-size:55px;line-height:1.2"><?php esc_html_e('The latest trends','clothing-store-blocks'); ?><br><?php esc_html_e('in fashion','clothing-store-blocks'); ?></h1>
<!-- /wp:heading -->
...
<div class="wp-block-buttons banner-btn"><!-- wp:button {"backgroundColor":"top-bg-color","style":{"border":{"radius":"0px"},"typography":{"fontSize":"13px","fontStyle":"normal","fontWeight":"500"},"spacing":{"padding":{"left":"var:preset|spacing|70","right":"var:preset|spacing|70","top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}}} -->
<div class="wp-block-button has-custom-font-size" style="font-size:13px;font-style:normal;font-weight:500"><a class="wp-block-button__link has-top-bg-color-background-color has-background wp-element-button" style="border-radius:0px;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--70)"><?php esc_html_e('SHOP NOW','clothing-store-blocks'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
