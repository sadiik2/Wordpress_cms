...
/**
 * Title: More Post
 * Slug: clothing-store-blocks/more-post
 * Categories: clothing-store-blocks, more-post
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('More Articles &amp; Posts','clothing-store-blocks'); ?></h3>
<!-- /wp:heading -->
