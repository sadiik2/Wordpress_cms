...
function clothing_store_blocks_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'clothing-store-blocks'), esc_html__('Begin Installation', 'clothing-store-blocks'), 'edit_theme_options', 'clothing-store-blocks-guide-page', 'clothing_store_blocks_guide');
}
...
function clothing_store_blocks_guide() {
	...
	<div class="getting-started__header">
		<div class="header-box-left">
			...
			<p><?php esc_html_e('Version: ', 'clothing-store-blocks'); ?><?php echo esc_html($theme['Version']);?></p>
		</div>
	...
	<div class="wrap getting-started">
		<div class="box-container">
			...
			<div class="box-right-main">
				...
				<img class="clothing_store_blocks_img_responsive" style="width: 100%;" src="<?php echo esc_url( $theme->get_screenshot() ); ?>" />
				<div class="pro-links">
					<hr>
